...
// img
import img1 from '../../assets/itachi-img.jpg'
import img2 from '../../assets/demonslayer-img.webp'
import img3 from '../../assets/zoro-img.jpg'

export default function Home() {

    return (
        <div>
            <div class={styles['anime-selector-container']}>
                <Link to="/this-week" class={styles['anime-selector-option']}>
                ...
                <div class={styles['anime-selector-option']}>
                    <div className={styles['anime-selector-img-container']}>
